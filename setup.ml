(* OASIS_START *)
(* DO NOT EDIT (digest: e7fadfcfb435c58cc206008c2c0211e1) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          sections =
            [
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("async",
                               Some (OASISVersion.VGreaterEqual "109.31.00"));
                           FindlibPackage
                             ("sexplib",
                      ...
                      },
                   {
                      ...
                      lib_findlib_name = Some "ocaml_plugin";
                      lib_findlib_containers = [];
                      });
               Library
                 ({
                     cs_name = "ocaml_plugin_fake_archive";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      lib_modules = ["Ocaml_plugin_dummy"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "ocaml_plugin";
                      lib_findlib_name = Some "fake";
                      lib_findlib_containers = [];
                      });
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "ocaml_plugin_fake_archive";
                           FindlibPackage ("sexplib.syntax", None);
                           FindlibPackage ("threads", None)
                        ];
                      bs_build_tools =
               ...
               Library
                 ({
                     cs_name = "ocaml_plugin_sample_archive";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                      ...
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlp4o"];
                      bs_c_sources = ["ocaml_sample_archive.c"];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("sexplib.syntax", None);
                           FindlibPackage ("threads", None);
                           InternalLibrary "ocaml_plugin_sample_archive"
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlp4o"];
                      bs_c_sources = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "plugin_loader.ml"; })
            ];
          plugins =
            [
     ...
     oasis_version = "0.3.0";
     oasis_digest =
       Some "\145\1838n\176\235\181\1302\172\224\164\151\172\163\134";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
