(* OASIS_START *)
(* DO NOT EDIT (digest: 971248609caccc686923d31d8a374487) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
                      ...
                      Some
                        (("ocamlfind",
                           [
                              ...
                              "-add";
                              "ocaml_plugin";
                              "_build/bin/ocaml_fake_archive.o";
                              "-dll";
                              "_build/bin/dllocaml-embed-compiler_stubs.so"
                           ])))
                 ];
               };
          uninstall_custom =
          ...
          sections =
            [
               ...
               Executable
                 ({
                     cs_name = "hello-world-standalone";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "run_standalone.ml"; 
                   });
               Executable
                 ({
                     cs_name = "sample";
               ...
               Executable
                 ({
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "plugin_loader_standalone.ml";
                      })
            ];
          plugins =
            [
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "(\233\254E~\007\158\127\255ee\159\174^\182\007";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
